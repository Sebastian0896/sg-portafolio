    ...
    <section className="min-h-screen flex flex-col md:flex-row items-center justify-center gap-10 px-6 bg-black text-gray-900">
        ...
        <div className="w-60 h-60 md:w-80 md:h-80 rounded-full overflow-hidden shadow-lg border">
            <Image
                ...
                width={1400}
                height={600}
                alt="Foto de Sebastián González Rodríguez"
        ...
        {/* <section className="about-section relative md:p-4">
           ...
           <div className="rounded-md shadow-cyan-700 shadow-xs   p-8 my-4 bg-white about relative w-full xs:w-full sm:w-full md:w-1/3 lg:w-full xl:w-2/4">
                ...
                <button className="bg-cyan-700 text-white text-sm rounded-xs hover:bg-cyan-600 transition-colors p-2 my-2"><Link href="/acerca">Saber más</Link></button>
           </div>
        </section> */}
