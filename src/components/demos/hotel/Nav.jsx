...
export default function Nav() {
  ...
  return (
    <header className="fixed inset-x-0 top-8 z-40 bg-white/90 backdrop-blur shadow-sm shadow-amber-100">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <a
          href="#habitaciones"
          className={cn(buttonVariants(), "hidden bg-amber-600 hover:bg-amber-700 md:inline-flex")}
        >
          Reservar
        </a>
