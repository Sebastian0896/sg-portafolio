    ...
    return(
        <Layout title="Acerca">
            <section className="relative h-screen">
                ...
                <div className="rounded-md shadow-cyan-700 shadow-sm   p-8 my-4 bg-white about relative w-full xs:w-full md:w-1/2 lg:w-1/2 xl:w-full 2xl:w-1/2">
